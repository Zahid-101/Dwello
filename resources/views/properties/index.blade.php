...
@section('content')
    ...
    <div class="listing-layout" style="display: flex; flex-direction: row; min-height: calc(100vh - 160px);">
        ...
        <div class="listing-sidebar"
            style="width: 320px; flex-shrink: 0; background: white; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); z-index: 10; padding: 24px; overflow-y: auto; border-right: 1px solid var(--gray-100);">
            <h2
                style="font-size: 20px; font-family: 'Poppins', sans-serif; font-weight: 600; color: var(--gray-900); margin-bottom: 24px;">
                Filters
            </h2>
        ...
        <div class="listing-content-wrapper" style="flex: 1; display: flex; flex-direction: row; position: relative;">
            {{-- Results --}}
            <div class="listing-results-container"
                style="flex: 1; overflow-y: auto; padding: 24px; height: calc(100vh - 160px);">
                <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 16px;">
                    <h2
                        style="font-size: 20px; font-family: 'Poppins', sans-serif; font-weight: 600; color: var(--gray-900);">
                ...
                <div style="display: flex; flex-direction: column; gap: 24px;">
                    @forelse ($properties as $property)
                        <div style="display: flex; flex-direction: row; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05); transition: transform 0.2s;"
                            onmouseover="this.style.transform='translateY(-2px)'"
                            onmouseout="this.style.transform='translateY(0)'" class="property-card-row">
                            {{-- Image placeholder --}}
                            <a href="{{ route('properties.show', $property) }}"
                                style="width: 280px; height: 200px; position: relative; flex-shrink: 0; display: block;"
                            ...
                            <div style="flex: 1; padding: 24px; display: flex; flex-direction: column;">
                                <div
                                    ...
                                    <h3
                                        style="font-family: 'Poppins', sans-serif; font-weight: 600; font-size: 18px; color: var(--gray-900);">
                                        <a href="{{ route('properties.show', $property) }}"
                                    ...
                                    <span
                                        style="font-size: 20px; font-weight: 700; color: var(--dwello-primary); white-space: nowrap; margin-left: 16px;">
                                        LKR {{ number_format($property->monthly_rent / 1000, 1) }}k
                                        <span style="font-size: 13px; color: var(--gray-500); font-weight: 400;">/mo</span>
                                    </span>
                                </div>
                                <p
                                    style="color: var(--gray-600); font-size: 14px; margin-bottom: 12px; display: flex; align-items: center; gap: 4px;">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                ...
                                <div
                                    ...
                                    <a href="{{ route('properties.show', $property) }}"
                                        style="color: var(--dwello-primary); font-weight: 500; text-decoration: none;">
                                        View Details →
                                    </a>
                                </div>
                            </div>
                    ...
                    @empty
                        <div
                            style="grid-column: 1 / -1; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 48px; text-align: center;">
                            <div
                                style="width: 64px; height: 64px; background: var(--gray-100); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-bottom: 16px;">
                                <svg style="width: 32px; height: 32px; color: var(--gray-400);" fill="none"
                            ...
                            <h3 style="font-size: 18px; font-weight: 600; color: var(--gray-900); margin-bottom: 8px;">No
                                properties found</h3>
            ...
            <div class="map-container"
                style="width: 40%; height: calc(100vh - 160px); background: var(--gray-100); position: sticky; top: 0;">
